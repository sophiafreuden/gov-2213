...
graph23 <- ht %>%
  ...
  labs(title = "Counts of Soros Mentions in News Articles", subtitle = "Articles selected from Hungary Today", caption = "Alterantive version with articles published on the same day summed together appended to this study.
...
graph30 <- ht %>%
  ...
  labs(title = "Counts of CEU Mentions in News Articles", subtitle = "Articles selected from Hungary Today", caption = "Alterantive version with articles published on the same day summed together appended to this study.
  Vertical lines denote Hungarian (Apr. 2018) and European Parliament (May 2019) elections.
       N = 453.", y = "Count", x = "Article Publishing Date")
